...
export { detectNegativeInstructionOverload } from './negative-instructions.js';
export { detectBuriedCriticalInstructions } from './buried-critical.js';
export { detectWithinSectionDedup } from './within-section-dedup.js';
